  ...
  <div class="h-screen overflow-hidden flex items-center justify-center bg-warm-100 dark:bg-warm-950 p-4 sm:p-6">
    <div class="w-full h-full max-h-full flex rounded-3xl overflow-hidden shadow-elevated bg-warm-50 dark:bg-warm-900">
        ...
        <div class="relative z-10 max-w-[480px] px-8">
          <div class="flex items-center gap-3 mb-8">
            <div class="w-11 h-11 rounded-xl bg-white/10 border border-white/20 flex items-center justify-center backdrop-blur-sm">
              <AppIcon icon="building-store" class="w-5 h-5 text-white" />
            </div>
            <div>
              <p class="text-primary-200 font-extrabold uppercase text-xs tracking-widest">EventGenius</p>
              <p class="text-white font-semibold opacity-80">Store Owners</p>
            </div>
          </div>
          <h2 class="text-white font-bold text-3xl tracking-tight mb-4">List your venues on EventGenius</h2>
          <p class="text-white/60 leading-relaxed mb-8">Register as a store owner to showcase your venues, manage bookings, and grow your business.</p>
      ...
      <div class="flex-1 flex items-center justify-center p-6 sm:p-12 overflow-hidden">
        ...
        <h1 class="text-xl font-bold text-warm-800 dark:text-white mb-1">Register as Store Owner</h1>
        <p class="text-warm-500 dark:text-warm-400 mb-6">
          Already have an account?
          <RouterLink to="/shop/sign-in" class="font-semibold text-primary-600 hover:text-primary-700">Sign in</RouterLink>
        </p>
        ...
        <form @submit.prevent="handleRegister" class="space-y-4">
          ...
          <div>
            ...
            <input v-model="form.password" type="password" required class="form-input" placeholder="Min. 8 characters" />
          </div>
...
const features = [
  'Showcase your venues to thousands of potential clients',
  'Manage bookings and availability in real-time',
  'Track revenue and grow your business effortlessly',
]
